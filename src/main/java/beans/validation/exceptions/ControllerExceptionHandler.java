...
public class ControllerExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(ValidateNameMarinBusinessException.class)
    public ResponseEntity<Object> handleEmptyResultDataAccessException(ValidateNameMarinBusinessException e) {
        log.error("eroare", e); //asa imi afisez eroarea
